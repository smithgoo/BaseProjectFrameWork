...
{
//    [ConfigInfo appLongitude:[NSString stringWithFormat:@"%f",newLocation.coordinate.longitude]];
//    [ConfigInfo appLatitude:[NSString stringWithFormat:@"%f", newLocation.coordinate.latitude]];
